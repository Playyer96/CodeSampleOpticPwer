...
namespace Hi5_Interaction_Core
{
    ...
    {
        public event Action OnPointingGesture;

        public event Action OnHandFist;

        public event Action OnHandPlane;

        public event Action OnHandOK;

        public event Action OnNoneGesture;

        private Hi5_Glove_Interaction_Hand mHand = null;
        private Hi5_Glove_Gesture_Recognition_Record mRecord = null;
        ...
        internal void Update(float detTime)
        {
            ...
            else
            {
                ...
                if (OnNoneGesture != null && isInGesture)
                {
                    isInGesture = false;
                    OnNoneGesture();
                }
    ...
    {
        internal Hi5_Glove_Gesture_Recognition_State mState = Hi5_Glove_Gesture_Recognition_State.ENone;
        private Queue<Hi5_Glove_Gesture_Recognition_State> mQueuePositionRecord = new Queue<Hi5_Glove_Gesture_Recognition_State>();
