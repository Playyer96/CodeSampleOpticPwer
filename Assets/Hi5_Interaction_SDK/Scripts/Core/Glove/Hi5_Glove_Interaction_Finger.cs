...
namespace Hi5_Interaction_Core
{
    ...
    public class Hi5_Glove_Interaction_Finger : MonoBehaviour
    {
        ...
        private Hi5_Glove_Interaction_Message mMessage = null;

        protected internal void SetHi5Hand(Hi5_Glove_Interaction_Hand hand)
        {
            mHand = hand;
        }
        ...
        #endregion Hi5_Glove_Interaction_Finger_Type
        ...
        private bool isPinchRelease = false;
        ...
        #endregion nodes Bone_Collider

        #region Angle

        private float GetAngle(Transform leftTransform, Transform midTransform, Transform rightTransform)
        {
        ...
        private float NormalizedAngle(float angleMin, float angleMax, float angle)
        {
        ...
        private int GetColliderObjectId()
        {
        ...
        protected internal void TailFingerCollider(int objectId)
        {
        }
